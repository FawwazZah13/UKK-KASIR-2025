                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        @if (isset($customer)) readonly @endif required>
                                </div>

                                <div class="form-group mb-3">
                                    <label for="poin" class="form-label">Poin</label>
                                    <input type="text" class="form-control" value="{{ $customer->poin ?? 0 }}" disabled>
                                </div>

                                <!-- Tambahkan input hidden poin yang akan digunakan -->
                                <input type="hidden" name="poin_tersedia" value="{{ $customer->poin ?? 0 }}">

                                <!-- Checkbox pakai poin -->
                                <div class="form-check mb-3">
                                    <input type="checkbox" name="gunakan_poin" value="1" class="form-check-input" id="gunakanPoin">
